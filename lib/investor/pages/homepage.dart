    ...
    final _desktopHomeCardList = [
      {
        'title': "Active Bids",
        'text':
            "Bids that you have submitted for invoices and vendor is yet to take action.",
          ...
          child: SingleChildScrollView(
            child: Padding(
              padding: Responsive.isMobile(context)
                  ? EdgeInsets.fromLTRB(15, 15, 8, 15)
              ...
              child: Column(
                ...
                children: [
                  ...
                  TopBarWidget("👋 Welcome ${userData['userName']},",
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: GeneratedCardWidget(
                              ...
                              currency: false,
                              subText:
                                  portfolioData.transactionCount.toString(),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          if (_profileProvider.portfolioData.up_pymt != null &&
                              _profileProvider.portfolioData.up_pymt.length > 0)
                            Padding(
                              ...
                              child: FutureBuilder<Object>(
                                  ...
                                  builder: (context, snapshot) {
                                    return Padding(
                                      ...
                                      child: Center(
                                        child: Text(
                                            "You do not have any payment due."),
                                      ),
                                    );
                                  }),
                            )
                            ...
                            Positioned(
                              ...
                              child: Container(
                                width: Responsive.isMobile(context)
                                    ...
                                    : 590,
                                height:
                                    Responsive.isMobile(context) ? 180 : 240,
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.only(
