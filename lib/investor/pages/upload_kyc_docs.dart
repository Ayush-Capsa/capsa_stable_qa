...
class _ChangePasswordPageState extends State<UploadKycDocument> {
  ...
  Widget build(BuildContext context) {
    ...
    if (profileProvider.portfolioData.investorType !=
        "individual") if ((profileProvider.portfolioData.kyc1 != 2 ||
      ...
      _str = "Re-upload documents";
        ...
        (profileProvider.portfolioData.kyc1 != null ||
            ...
            profileProvider.portfolioData.kyc2 != null)) {
      if (profileProvider.portfolioData.investorType ==
          "individual") if ((profileProvider.portfolioData.kyc1 !=
              2) &&
          (profileProvider.portfolioData.kyc1 != null))
    ...
    if (profileProvider.portfolioData.investorType == "individual") {
      _str = '';
      if ((profileProvider.portfolioData.kyc1 != 2) &&
          (profileProvider.portfolioData.kyc1 != null)) {
        _str = "Pending for approval";
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              TopBarWidget("Upload Kyc Documents", _str),
              SizedBox(
                height: 15,
              ),
              uploadKYCDocuments(context, profileProvider, showButton),
            ],
          ),
        ),
      ),
  ...
  uploadKYCDocuments(
      BuildContext context, ProfileProvider profileProvider, bool showButton) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (profileProvider.portfolioData.investorType == "individual")
            if (profileProvider.portfolioData.kyc1 != 2 &&
              ...
              Column(
                children: [
                  Text(
                    "A copy of any national acceptable ID: Driver\'s licence, International Passport, NIN (National Identity Number) Voter\'s Card",
                    style: TextStyle(
              ...
              InkWell(
                  onTap: () async {
                    var _body = {
                      'fName': profileProvider.portfolioData.kyc1File
                    };
                    openFiles(profileProvider, _body, "Certificate");
                  },
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
          ...
          // if (profileProvider.portfolioData.investorType != "individual")
          //   if (profileProvider.portfolioData.kyc3 != 2 && profileProvider.portfolioData.kyc3 != 1)
          //     UserTextFormField(
          //       padding: EdgeInsets.only(bottom: 5),
          //       controller: kyc3Controller,
          //       onTap: () => pickFile(kyc3Controller, 'kyc3'),
          //       readOnly: true,
          //       label: "Upload Valid ID (NIN / Voters or Passport)",
          //       hintText: "PDF or Image file",
          //       suffixIcon: Padding(
          //         padding: const EdgeInsets.all(8.0),
          //         child: Image.asset(
          ...
          //         openFiles(profileProvider, _body, "NIN / Voters or Passport");
          //       },
          //       child: Padding(
          //         padding: const EdgeInsets.all(8.0),
          //         child: Text(
          ...
          //       if ((profileProvider.portfolioData.investorType ==
          //                   "individual" &&
          //               profileProvider.portfolioData.kyc1 != 2) ||
          //           profileProvider.portfolioData.investorType != "individual")
          //         if (showButton)
          //           Padding(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          await profileProvider.queryPortfolioData2();
                          setState(() {
                            loadingKYC = false;
                          });
                        },
