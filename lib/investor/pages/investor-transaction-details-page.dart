...
class InvestorTransactionDetailsPage extends StatefulWidget {
  ...
  const InvestorTransactionDetailsPage(this.invNum, {Key key, this.onlyBid, this.amt}) : super(key: key);

  @override
  State<InvestorTransactionDetailsPage> createState() => _InvestorTransactionDetailsPageState();
}

class _InvestorTransactionDetailsPageState extends State<InvestorTransactionDetailsPage> {
          ...
          return AlertDialog(
            ...
            content: Padding(
              ...
              child: FutureBuilder<Object>(
                  future: proposalProvider.loadPurchaseAgreement(_proposalModel, 'false'),
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (_proposalModel.digital_name_buyer == null || _proposalModel.digital_name_buyer.trim() == '')
                                Align(
                                    ...
                                    if (!processing)
                                      SizedBox(
                                        ...
                                        style: TextStyle(
                                          ...
                                          onPressed: () async {
                                        if (dName.trim() == '' || dName == null) {
                                          showToast('Please Enter Digital Name Field', context, type: 'warning');
                                          return;
                                        }
                                        ...
                                        dynamic _response = await proposalProvider.loadPurchaseAgreement(_proposalModel, 'true', dName: dName);
                                        if (_response['res'] == 'success') {
                                          var url = _response['data']['url'];
                                          // capsaPrint(url);
                                          showToast('Downloading please wait...', context, type: 'info');
                                          await proposalProvider.downloadFile(url);
                                          setState(() {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TopBarWidget(widget.onlyBid ? "Bid Details" : "Transaction Details", ""),
              if (!Responsive.isMobile(context))
                SizedBox(
                  height: 18,
                ),
              FutureBuilder(
                  future: Provider.of<InvoiceProvider>(context, listen: false).loadInVData(widget.invNum, widget.amt),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState != ConnectionState.done) {
                      ...
                      if (data['res'] == 'success') {
                        _data = data['data'];
                        var element = _data['ilplist'].isEmpty?null:_data['ilplist'][0];

                        openInvoices = element!=null?OpenDealModel(
                        ...
                        if (_data['digital'] != null && _data['digital'].length > 0) {
                          var element2 = _data['digital'][0];
                          _proposalModel = openInvoices!=null?ProposalModel(
                            ...
                            minimum_investment: openInvoices.minimum_investment,
                            invoice_number: openInvoices.invoice_number,
                            description: openInvoices.description,
                            customer_name: openInvoices.customer_name,
                            comp_contract_address: openInvoices.comp_contract_address,
                            child_address: openInvoices.child_address,
                            discount_percentage: openInvoices.discount_percentage,
                            ...
                            digital_name_accept_time: element2['digital_name_accept_time'],
                            digital_name_buyer: element2['digital_name_buyer'],
                            digital_name_buyer_accept_time: element2['digital_name_buyer_accept_time'],
                          ):null;
                          print('pass 2');
                        }
                      } else {
                      ...
                      return Container(
                        ...
                        child: Column(
                          children: [
                            bidDetailsFrameStatus(context, _data, isDetails: widget.onlyBid),
                            SizedBox(
                            ...
                            Builder(builder: (context) {
                              ...
                              return Row(
                                children: [
                                  openInvoices!=null?Flexible(flex: 4, child: bidDetailsFrameTopInfo(context, openInvoices, isDetails: widget.onlyBid)):Container(),
                                  if (!Responsive.isMobile(context))
                                    if (isdownload)
                                      SizedBox(
                                        width: 25,
                                        ...
                                        child: Container(
                                          child: Column(
                                            children: [
                                              ...
                                              InkWell(
                                                onTap: () {
                                                  downloadCall(context, proposalProvider);
                                                },
                                                child: Container(
                            ...
                            openInvoices!=null?bidDetailsInfo(openInvoices, context):Container(),
                            SizedBox(
                              height: 20,
                            ),
                            if (Responsive.isMobile(context))
