        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              padding: EdgeInsets.symmetric(horizontal: Responsive.isMobile(context) ? 2:  8, vertical: Responsive.isMobile(context) ? 8:  8),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: <Widget>[
                  Text(
...
Widget bidDetailsFrameTopInfo(BuildContext context,OpenDealModel openInvoices, {isDetails: false}) {
  return Container(
    ...
    padding: EdgeInsets.symmetric(horizontal:  Responsive.isMobile(context) ? 10 :  24, vertical:  Responsive.isMobile(context) ? 25:  29),
    child: Row(
        ...
        if (!isDetails)
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  Responsive.isMobile(context) ? 'Amount Payable' :   'Amount Payable to Vendor',
                  textAlign: TextAlign.left,
                  style: TextStyle(
                      color: Color.fromRGBO(51, 51, 51, 1),
...
Widget drawBidPanel(String type, OpenDealModel openInvoices, BuildContext context) {
      ...
      children: [
            ...
            children: <Widget>[
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Image.asset(
                      isF ? "assets/images/Frame 83.png" : "assets/images/Frame 834.png",
                      width: 60,
                    ),
                    SizedBox(width: 8),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            isF ? openInvoices.customer_name.truncateTo(Responsive.isMobile(context) ? 16 : 30) : openInvoices.companyName.truncateTo(Responsive.isMobile(context) ? 16 : 30),
                            textAlign: TextAlign.left,
                            style: TextStyle(
                                color: Color.fromRGBO(51, 51, 51, 1),
                                fontFamily: 'Poppins',
                          ...
                          SizedBox(height: 8),
                          Text(
                            'CAC: ' + (isF ? openInvoices.customerCIN : openInvoices.sel_CIN),
                            textAlign: TextAlign.left,
                            style: TextStyle(
                                color: Color.fromRGBO(51, 51, 51, 1),
                                fontSize: 14,
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  color: isF ? Color.fromRGBO(58, 192, 201, 1) : HexColor("#0098DB"),
                ),
        ...
        Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              _textDraw("Industry", isF ? openInvoices.industry : openInvoices.sel_industry),
              _textDraw(
                  "Founded",
                  isF
                      ? DateFormat('d MMM,y').format(DateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parse(openInvoices.founded)).toString()
                      : DateFormat('d MMM,y').format(DateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parse(openInvoices.sel_founded)).toString()),
              _textDraw("Key Promoter", isF ? openInvoices.key_person : openInvoices.sel_key_person),
              // _textDraw("Credit Profile", "Not available"),
              // _textDraw("Returns", "Filed on "),
              _textDraw("Invoice Status", "Verified"),
              _textDraw("", (isF ? "View Anchor Analysis" :  "View Vendor Analysis"),onTap :(){}),
      ...
      children: <Widget>[
        ...
        InkWell(
          ...
          child: Text(
            ...
            textAlign: TextAlign.left,
            style: TextStyle(
                color: onTap != null ? HexColor("#0098DB") : Color.fromRGBO(51, 51, 51, 1),
                fontFamily: 'Poppins',
                fontSize: 14,
                letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                fontWeight: FontWeight.normal,
