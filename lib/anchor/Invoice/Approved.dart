...
class _approvedScreenState extends State<approvedScreen> {
  ...
  void createCSV(){
    ...
    csv_rows.add(["S/N", "Invoice No.", "Vendor Name", "Issue Date", "Invoice Amount (in Naira)", "Due Date","Tenure","Approved By"]);
    for (int i = 0; i < _acctTable.length; i++) {
      ...
      row.add(_acctTable[i].approvedBy);
      csv_rows.add(row);
    }
    String dataAsCSV = const ListToCsvConverter().convert(
      csv_rows,
    );
    exportToCSV(dataAsCSV, fName: "Approved Invoice");
  }
  ...
  void getData(BuildContext context) async{
    ...
    if(_fetchedAcctTable.isEmpty) {
      _fetchedAcctTable = await anchorsActions.queryInvoiceList(3);
    }
    ...
    for(int i = 0;i<limit;i++){
      rows.add(
          TableRow(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top:8.0),
              child: Text(_acctTable[i].invNo.toString(), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
            ...
            Padding(
              padding: const EdgeInsets.only(top:8.0),
              child: Text(_acctTable[i].vendor.toString(), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
            ...
            Padding(
              padding: const EdgeInsets.only(top:8.0),
              child: Text(_acctTable[i].invDate.toString(), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
            ...
            Padding(
              padding: const EdgeInsets.only(top:8.0),
              child: Text("₦ " + formatCurrency(_acctTable[i].invAmt), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
            ...
            Padding(
              padding: const EdgeInsets.only(top:8.0),
              child: Text(_acctTable[i].invDueDate.toString(), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
            ...
            Padding(
              padding: const EdgeInsets.only(top:8.0),
              child: Text(_acctTable[i].tenure.toString(), style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
            ...
            Padding(
              padding: const EdgeInsets.only(top: 8, bottom: 8),
              child: Text(_acctTable[i].approvedBy, style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
                color: Color.fromRGBO(51, 51, 51, 1),
              )),
  ...
  void _nextPage(){
    if(_currentIndex<_numberOfPages){
      ...
      _currentIndex++;
      int limit = 10<(_acctTable.length - (_currentIndex - 1)*10)?10:(_acctTable.length - (_currentIndex - 1)*10);

      for(int i = (_currentIndex-1) * 10;i<((_currentIndex - 1)*10) + limit;i++){
  ...
  void _previousPage(){
    if(_currentIndex>1){
      ...
      _currentIndex--;
      for(int i = (_currentIndex-1) * 10;i<((_currentIndex - 1) * 10 ) + 10;i++){
        rows.add(
            TableRow(children: [
              Padding(
                padding: const EdgeInsets.only(top:8.0),
