...
class AddInvoiceAnchor extends StatefulWidget {
  AddInvoiceAnchor({
    Key key,
  }) : super(key: key);

  @override
  State<AddInvoiceAnchor> createState() => _AddInvoiceAnchorState();
}

class _AddInvoiceAnchorState extends State<AddInvoiceAnchor> {
  ...
  TextEditingController pfeeController = TextEditingController(text: '');
                                            ...
                                            children: [
                                              ...
                                              Flexible(
                                                child: UserTextFormField(
                                                  ...
                                                  onChanged: (v) {
                                                    // if(rateController2.text == '' || invoiceAmtController.text == ''){
                                                    ...
                                                    //   buyAmtController.text = (num.parse(invoiceAmtController.text) - (((num.parse(rateController2.text))/100) * num.parse(invoiceAmtController.text))).toString();
                                                    // }else{
                                                    //   buyAmtController.text = '';
                                                    // }
                                              ...
                                              if (_formKey.currentState.validate()) {
                                                {
                                                  ...
                                                  dynamic invoiceFormData = {
                                                    ...
                                                    "invAmt": grossController.text,
                                                    "butAmt": (num.parse(grossController.text) - num.parse(rateAmountController.text)).toString(),
                                                    ...
                                                    showExtendedDate,
                                                    "grade": grade,
                                                    "vendorPan": selectedVendorPan,
                                                    "vendorName": vendorController.text,
                                                    'platformFee': pfeeController.text,
                                                    'actualValue' : invoiceAmtController.text
                                                  };

                                                  capsaPrint('Invoice FOrm Data - ${invoiceFormData['extendedDueDateString']} ${invoiceFormData['vendorName']} ${invoiceFormData['vendorPan']}');
                                                    ...
                                                    showDialog(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) => MultiProvider(
                                                            ...
                                                            child: ConfirmInvoicePageAnchor(invoiceProvider: invoiceProvider,),
                                                          )
                                                      ),
                                                    ));
                                                  } else {
