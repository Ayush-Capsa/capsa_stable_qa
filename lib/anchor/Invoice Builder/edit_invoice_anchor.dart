...
class EditInvoiceAnchor extends StatefulWidget {
  ...
  @override
  State<EditInvoiceAnchor> createState() => _EditInvoiceAnchorState();
}

class _EditInvoiceAnchorState extends State<EditInvoiceAnchor> {
  ...
  void initState() {
    ...
    if (true) {
      ...
      dateCont.text = DateFormat('yyyy-MM-dd')
          .format(DateFormat("dd MMM, yyyy").parse(widget.invoice.issueDate))
          .toString();
      _selectedDate =
          DateFormat("dd MMM, yyyy").parse(widget.invoice.issueDate);
      dueDateCont.text = DateFormat('yyyy-MM-dd')
          .format(DateFormat("dd MMM, yyyy").parse(widget.invoice.dueDate))
          .toString();
      _selectedDueDate =
          DateFormat("dd MMM, yyyy").parse(widget.invoice.dueDate);
      ...
      //     .parse(widget.invoice.dueDate);
      tenureDaysDiff = DateFormat("dd MMM, yyyy")
          .parse(widget.invoice.dueDate)
          .difference(
              DateFormat("dd MMM, yyyy").parse(widget.invoice.issueDate))
          .inDays;
                  ...
                  FutureBuilder<Object>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasError) {
                          ...
                          pfeePercent =
                              _data['data'][0]['capsa_rate'].toString();
                          capsaPrint('1 $pfeePercent');

                          capsaPrint(
                              '${amtToPayController.text} ${grossController.text} ${pfeeController.text} ${pfeePercent}');
                          ...
                          if (_data['res'] == 'success') {
                            ...
                            anchorNameList.forEach((element1) {
                              if (element1['name'] == anchor) {
                                ...
                                anchor = element1['name_address'];
                                //pfeeController.text = element1['capsa_rate'].toString();
                                pfeePercent = element1['capsa_rate'].toString();
                                num rate = rateController2.text == ''
                                    ? 0
                                    : ((num.parse(rateController2.text) / 100) *
                                        num.parse(invoiceAmtController.text));
                                rateAmountController.text = rate.toStringAsFixed(2);
                                num pfee = ((num.parse(pfeePercent) / 100) *
                                    num.parse(invoiceAmtController.text));

                                amtToPayController.text =
                                    (rate + pfee).toStringAsFixed(2);
                                capsaPrint('2');
                                ...
                                grossController.text =
                                    (num.parse(invoiceAmtController.text) +
                                            ...
                                            pfee)
                                        .toStringAsFixed(2);
                                grade = anchorGrade[anchor];
                                capsaPrint('Grade initiated :  $grade');
                                                ...
                                                child: UserTextFormField(
                                                  ...
                                                  onChanged: (v) {
                                                    if (invoiceAmtController
                                                      ...
                                                      num rate = rateController2
                                                                  .text ==
                                                              ''
                                                          ? 0
                                                          : ((num.parse(rateController2
                                                                      .text) /
                                                                  100) *
                                                              num.parse(
                                                                  invoiceAmtController
                                              ...
                                              Flexible(
                                                child:  UserTextFormField(
                                                    ...
                                                    onChanged: (v) {
                                                      ...
                                                      rateAmountController.text = rate.toString();
