...
class editPrivileges extends StatefulWidget {
  subAdmin admin;
  editPrivileges({Key key,@required this.admin}) : super(key: key);

  @override
  _editPrivilegesState createState() => _editPrivilegesState();
}
...
class _editPrivilegesState extends State<editPrivileges> {
