            ...
            child: Table(
              ...
              children: [
                TableRow(children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(top: 8, bottom: 8),
                    child: Text('Date', style: tableHeading()),
                  ),
                  Container(
                    padding: const EdgeInsets.only(top: 8, bottom: 8),
                    child: Text('Status', style: tableHeading()),
                  ),
                ]),
                TableRow(children: [
                  ...
                  Text('2021-10-04', style: tableContent()),
                  Text('Paid', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: Color.fromRGBO(33, 150, 83, 1)))
                ]),
                TableRow(children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 8, bottom: 8),
                  ...
                  Padding(
                    ...
                    child: Text('2021-10-04', style: tableContent()),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(right: 35, top: 8),
                    child: Text('Paid', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400, color: Color.fromRGBO(33, 150, 83, 1)))
                  )
                ]),
                TableRow(children: [
