...
class upcoming30Screen extends StatefulWidget {
  const upcoming30Screen({Key key}) : super(key: key);

  @override
  _upcoming30ScreenState createState() => _upcoming30ScreenState();
}

class _upcoming30ScreenState extends State<upcoming30Screen> {
  List<Widget> card = [];
  ...
  void getData(BuildContext context) async {
    ...
    data = await anchorsActions.getNextMonthUpcomingPayments();
    card.add(
      Padding(
                        ...
                        child: RichText(
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text:
                                        'of your Total Payout is due in 8 - 30 days',
                                    style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        color: Color.fromRGBO(51, 51, 51, 1),
                                        fontSize: 18))
