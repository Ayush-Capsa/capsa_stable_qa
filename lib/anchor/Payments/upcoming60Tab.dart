...
class upcoming60Screen extends StatefulWidget {
  const upcoming60Screen({Key key}) : super(key: key);

  @override
  _upcoming60ScreenState createState() => _upcoming60ScreenState();
}

class _upcoming60ScreenState extends State<upcoming60Screen> {
  List<Widget> card = [];
  ...
  void getData(BuildContext context) async {
    ...
    data = await anchorsActions.paymentsDueIn60days();
    card.add(
      Padding(
                        ...
                        child: RichText(
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text:
                                    'of your Total Payout is due in 45 - 60 days',
                                    style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        color: Color.fromRGBO(51, 51, 51, 1),
                                        fontSize: 18))
