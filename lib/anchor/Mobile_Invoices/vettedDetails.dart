...
class vettedDetails extends StatelessWidget {
  const vettedDetails({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    selectedInvoiceTab = 1;
    return Scaffold(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: 22, bottom: 21),
                child: Text(
                  'Amount vendor gets paid. If this is incorrect, kindly edit',
                  style: TextStyle(
                      fontSize: 10,
                      fontWeight: FontWeight.w400,
                      color: Color.fromRGBO(235, 87, 87, 1)
