...
class upcoming30Days extends StatefulWidget {
  const upcoming30Days({Key key}) : super(key: key);

  @override
  State<upcoming30Days> createState() => _upcoming30DaysState();
}

class _upcoming30DaysState extends State<upcoming30Days> {
        ...
        child: Container(
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Text(
                'Other payments due in 8-30 days',
                style: TextStyle(
                          ...
                          child: RichText(
                            text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                      text:
                                          'of your Total Payout is due in 8 - 35 days',
                                      style: TextStyle(
