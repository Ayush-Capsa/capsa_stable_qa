...
class upcoming60Days extends StatefulWidget {
  const upcoming60Days({Key key}) : super(key: key);

  @override
  State<upcoming60Days> createState() => _upcoming60DaysState();
}

class _upcoming60DaysState extends State<upcoming60Days> {
  List<Widget> upcoming60daycard = [];
                          ...
                          child: RichText(
                            text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                      text:
                                      'of your Total Payout is due in 60 days',
                                      style: TextStyle(
