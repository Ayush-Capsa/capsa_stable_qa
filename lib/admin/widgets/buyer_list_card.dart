...
class BuyerListCard extends StatelessWidget {
  final List<InvestorData> enquiryData;
  final String title;

  const BuyerListCard({Key key, this.enquiryData, this.title})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          final InvestorData data = enquiryData[index];
          return Padding(
            ...
            child: Card(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  tab.changeTab2(
                      0, index, data, 'InvestorEdit', 'InvestorEdit');
                },
                child: Row(
