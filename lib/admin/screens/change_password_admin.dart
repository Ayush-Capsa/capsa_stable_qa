...
class ChangePasswordPageAdmin extends StatefulWidget {
  bool canGoBack;
  ChangePasswordPageAdmin({Key key, this.canGoBack = true}) : super(key: key);

  @override
  State<ChangePasswordPageAdmin> createState() =>
      _ChangePasswordPageAdminState();
}

class _ChangePasswordPageAdminState extends State<ChangePasswordPageAdmin> {
