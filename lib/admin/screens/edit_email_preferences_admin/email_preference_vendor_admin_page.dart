...
class EmailPreferenceVendorAdminPage extends StatefulWidget {
  AccountData data;
  EmailPreferenceVendorAdminPage({Key key, this.data}) : super(key: key);

  @override
  State<EmailPreferenceVendorAdminPage> createState() => _EmailPreferenceVendorAdminPageState();
}

class _EmailPreferenceVendorAdminPageState extends State<EmailPreferenceVendorAdminPage> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              preferenceCheck(
                                  ...
                                  'Sale of Invoice',
                                  'Get notified when the sale of an invoice has been completed successfully'),
                              preferenceCheck(
                                  Checkbox(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        dynamic response = await profileProvider.setUserEmailPreference(_body,panNumber: widget.data.panNumber);
  ...
  void _asyncmethodCall(ProfileProvider profileProvider) async {
    ...
    //final profileProvider = Provider.of<ProfileProvider>(context);
    capsaPrint('Pass 3');
    dynamic data = await profileProvider.getUserEmailPreference(panNumber: widget.data.panNumber, role: 'VENDOR');
    capsaPrint('Pass 4');
    capsaPrint('\n\nResponse : $data');
    emailController.text = data['data']['email'];
    // emailController.text = 'xx';
