...
class _VendorEditState extends State<VendorEdit> {
  ...
  openFiles(ActionModel actionModel, _body, name, kycNo) async {
    ...
    if (kycNo == 1) {
      if (data.kyc1 == 'null') {
        if (_body['fName'] != null || _body['fName'] != '') {
        } else {
          noFileAlert();
          return;
        }
    ...
    return Scaffold(
      body: FutureBuilder<Object>(
          future: Provider.of<ActionModel>(context, listen: false)
              .queryVendorView(data.bvnNum),
          builder: (BuildContext context, AsyncSnapshot<Object> snapshot) {
            if (snapshot.hasData) {
              capsaPrint("Tushar HERE @@@@");
              // capsaPrint(title);
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  ...
                                                  openFiles(
                                                      actionModel,
                                                      _body,
                                                      "CAC fork C07 (Particulars of Directors)",
                                                      2);
                                                },
                                                child: Text(
                                                  "View CAC Form 7 ",
