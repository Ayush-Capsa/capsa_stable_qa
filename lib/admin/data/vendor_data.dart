...
class VendorListDataSource extends DataTableSource {
  final BuildContext context;
  final String title;

  List<VendorData> data = <VendorData>[
    // HistoryData('SBI', 'IJK45AGHJI', '1234567890', '22 Feb, 2021', '2 Days',
    //     '10,000', 'Open'),
  ];

  VendorListDataSource(this.context, this.data, this.title);

  // void _sort<T>(Comparable<T> getField(VendorData d), bool ascending) {
  //   data.sort((VendorData a, VendorData b) {
  //     if (!ascending) {
  //       final VendorData c = a;
  //       a = b;
  //       b = c;
  //     }
  ...
  DataRow getRow(int index) {
    ...
    var statusCellStyle2 = TextStyle(
      color: Colors.red[800],
      fontSize: 14,
      fontWeight: FontWeight.normal,
    );
    ...
    if (d.alUpload != null) {
      if (d.alUpload == '1') {
        text_1 = 'Document Pending';
        statusCellStyle2 = TextStyle(
          color: Colors.blueAccent,
          fontSize: 14,
          fontWeight: FontWeight.normal,
        );
      } else if (d.alUpload == '2') {
        text_1 = 'Document Approved';
        statusCellStyle2 = TextStyle(
          color: Colors.green[800],
          fontSize: 14,
          fontWeight: FontWeight.normal,
...
class _TestWidgetState extends State<TestWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return TextButton(
      ...
      onPressed: () async {
        tab.changeTab2(0, widget.index, widget.d, 'VendorEdit', 'VendorEdit');
      },
      child: Text(
        'View',
