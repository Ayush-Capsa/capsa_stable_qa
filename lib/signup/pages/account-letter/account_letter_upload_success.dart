...
class AccountLetterUploadSuccessPage extends StatefulWidget {
  const AccountLetterUploadSuccessPage({Key key}) : super(key: key);

  @override
  State<AccountLetterUploadSuccessPage> createState() => _AccountLetterUploadSuccessPageState();
}

class _AccountLetterUploadSuccessPageState extends State<AccountLetterUploadSuccessPage> {
