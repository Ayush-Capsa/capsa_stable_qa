...
class _OnBoardPageState extends State<EnterDetailsPage> {
  ...
  void showNamingDialog(BuildContext context) async{
  ...
  void initState() {
    ...
    bvnController0.text = formatPanNumber(_body['panNumber']);
                                    ...
                                    : InkWell(
                                        onTap: () async {
                                          ...
                                          if (formKey.currentState.validate()) {
                                            ...
                                            _body['extensionCAC'] = ccFile!=null?ccFile.extension:'';
                                            _body['extensionFORM7'] = f7File!=null?f7File.extension:'';
                                            _body['extensionValid_id'] = idFile!=null?idFile.extension:'';
                                            ...
                                            capsaPrint('Pass 3');
                                            if (role2 != 'individual') {
                                              capsaPrint('saveDetails1');
                                              _response = await _actionProvider
                                                  .saveDetails1(
                                                      _body, ccFile, f7File);
                                            } else {
                                              capsaPrint('saveDetails3');
                                              _response = await _actionProvider
                                                  .saveDetails3(_body, idFile);
                                            }
                                            capsaPrint('Pass 4 $_response');
