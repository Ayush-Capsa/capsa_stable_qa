...
class VerificationUnsuccessful extends StatefulWidget {
  const VerificationUnsuccessful({Key key}) : super(key: key);

  @override
  State<VerificationUnsuccessful> createState() => _VerificationUnsuccessfulState();
}

class _VerificationUnsuccessfulState extends State<VerificationUnsuccessful> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //if (role != "COMPANY")
                        Text(
                          "Your account could not be verified.\nYour KYC document(s) have been rejected. This could be because:\n\n1. You uploaded the wrong document\n2. The document you uploaded wasn't clear enough.\nKindly reupload the document(s).              ",
                          textAlign: TextAlign.left,
                          style: TextStyle(
                              color: Color.fromRGBO(51, 51, 51, 1),
                              // fontFamily: 'Poppins',
                        ...
                        SizedBox(
                          ...
                          child: InkWell(
                            onTap: () async{
                              context.beamToNamed('/reupload-document-page');
                            },
                            child: Container(
                              width: double.infinity,
                              height: 50,
