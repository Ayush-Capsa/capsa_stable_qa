...
class EmailPreferenceAnchorPage extends StatefulWidget {
  const EmailPreferenceAnchorPage({Key key}) : super(key: key);

  @override
  State<EmailPreferenceAnchorPage> createState() => _EmailPreferenceAnchorPageState();
}

class _EmailPreferenceAnchorPageState extends State<EmailPreferenceAnchorPage> {
