...
class GeneratedCardWidget extends StatelessWidget {
  ...
  const GeneratedCardWidget({this.color, this.width, this.helpText, this.title, this.subText, this.icon, this.withdrawSection, this.currency, this.isWithDrawCard : false, this.addNewBene = false, Key key}) : super(key: key);
